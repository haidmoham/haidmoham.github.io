...
$content = $content -replace '<title>[^<]*</title>', '<title>Social Vulnerability vs. Health Outcomes — Phase 1 | Mohammad Haider</title><link rel="icon" type="image/svg+xml" href="/favicon.svg" />'
...
Write-Host "   3. git commit -m 'Update notebook export'"
